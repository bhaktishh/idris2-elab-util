...
deriveDecEq a = do 
    ...
    logMsg "auto" 1 $ "pairs: " ++ show pairs 
    logMsg "auto" 1 $ "tiCons: " ++ show (map (.name) ti.cons)
    ...
    logMsg "auto" 1 $ "interfaceHint claim: \n" ++ show fName ++ " : " 
      ++ show clHint
    logMsg "auto" 1 $ "interfaceHint def: \n" 
      ++ show (def fName [var fName .= impl ])
